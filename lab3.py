...
# 1. Create the dataset based on your image
data = {
    'JOB_ID': [
    ...
    'MIN_SALARY': [
        20080, 15000, 3000, 8200, 4200, 8200, 4200, 10000, 6000,
        8000, 2500, 5500, 2008, 2500, 4000, 9000, 4000, 4000, 4500
    ],
    'MAX_SALARY': [
        40000, 30000, 6000, 16000, 9000, 16000, 9000, 20080, 12008,
...
# 3. Sort by 'JOB_TITLE' in descending order (Z -> A)
sorted_df = df.sort_values(by='JOB_TITLE', ascending=False)

# 4. Display the result
print("Jobs sorted by Job Title (Descending):")
print(sorted_df)
